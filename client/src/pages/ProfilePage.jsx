...
const ProfilePage = () => {
  ...
  const handleSubmit=async(e)=>{
    ...
    // After saving, navigate back to home page
    navigate('/');
    return;
    }

    // Agar hume image bhi bhejna hua to hum usse pahele base 64 image me convert karenge.
  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5 p-10 flex-1">
        ...
        <label htmlFor="avatar" className='flex items-center gap-3 cursor-pointer'> {/* Label tag isliye use kiye hain taaki..... */}
